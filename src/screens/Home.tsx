    ...
    <div className="flex flex-col items-center justify-center min-h-[80vh] px-4">
      ...
      >
        ...
        <button 
          ...
          className="group relative flex flex-col items-center p-8 rounded-2xl bg-slate-900/40 border border-slate-800 hover:border-cyan-500/50 hover:bg-slate-900/60 transition-all duration-300 backdrop-blur-sm hover:cyan-glow overflow-hidden"
        >
          ...
          <div className="w-16 h-16 rounded-2xl bg-slate-800flex flex-col items-center justify-center mb-6 bg-slate-800/80 group-hover:scale-110 transition-transform duration-300 flex items-center shadow-lg shadow-black/50">
            <UploadCloud className="w-8 h-8 text-cyan-400 relative z-10" />
          </div>
        ...
        <button 
          ...
          className="group relative flex flex-col items-center p-8 rounded-2xl bg-slate-900/40 border border-slate-800 hover:border-indigo-500/50 hover:bg-slate-900/60 transition-all duration-300 backdrop-blur-sm hover:shadow-[0_0_24px_-6px_rgba(99,102,241,0.4)] overflow-hidden"
        >
          ...
          <div className="w-16 h-16 rounded-2xl bg-slate-800/80 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg shadow-black/50">
            <DownloadCloud className="w-8 h-8 text-indigo-400 relative z-10" />
          </div>
